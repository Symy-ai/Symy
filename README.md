...
- [`doc/symy-lab/`](doc/symy-lab/) — public design documents on Symy's governance philosophy, symbiotic AI, and the Dao behind the project (constitution, governance brief, symbiotic AI, Dao De Jing reading).
