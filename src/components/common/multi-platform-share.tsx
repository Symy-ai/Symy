...
/** 品牌图标 (fill currentColor) — PLATFORMS 与其他分享面 (share/direct-share-row) 的单一来源 */
export const SHARE_PLATFORM_ICONS = {
  x: (
...
const PLATFORMS: PlatformConfig[] = [
  ...
  },
  {
    ...
    label: 'X',
    color: 'bg-black',
    icon: SHARE_PLATFORM_ICONS.x,
  },
  {
    id: 'reddit',
    label: 'Reddit',
    color: 'bg-orange-500',
    icon: SHARE_PLATFORM_ICONS.reddit,
  },
  {
    id: 'whatsapp',
    label: 'WhatsApp',
  ...
  // 以下平台不支持 web intent 直接分享图片, 显示"保存图片 + 打开 app"引导
  {
    ...
    icon: SHARE_PLATFORM_ICONS.instagram,
  },
  {
    id: 'tiktok',
    label: 'TikTok',
    color: 'bg-black',
    needsImageSaveGuide: true,
    icon: SHARE_PLATFORM_ICONS.tiktok,
  },
  {
    id: 'wechat',
    label: 'WeChat',
